 ...
 * Small label in top-left, LIVE badge when streaming.
 */
export function CameraPanel({ label, active, videoSrc, stream }: CameraPanelProps) {
  ...
  return (
    <div className={`camera-panel ${active ? 'active' : ''}`} id={`camera-${label.toLowerCase()}`}>
